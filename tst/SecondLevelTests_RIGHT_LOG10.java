...
public class SecondLevelTests_RIGHT_LOG10 {
    ...
    public static void initStubs() throws IllegalArgumentException {
        ...
        LOG2 log2Module = Mockito.mock(LOG2.class);
        ...
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("a"))).thenReturn(-19.931569);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("ae"))).thenReturn(-20.931569);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("b"))).thenReturn(-6.285167);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("b1"))).thenReturn(-6.285280);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("b2"))).thenReturn(-6.285055);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("bo1"))).thenReturn(-1.945544);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("bo2"))).thenReturn(-0.981618);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("bo3"))).thenReturn(-0.408884);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("c"))).thenReturn(6.284735);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("c1"))).thenReturn(6.284735);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("c2"))).thenReturn(6.284735);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("cd1"))).thenReturn(9.053661);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("cd2"))).thenReturn(9.943747);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("cd3"))).thenReturn(10.490128);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("d"))).thenReturn(10.885481);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("d1"))).thenReturn(10.885481);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("d2"))).thenReturn(10.885481);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("di"))).thenReturn(11.550747);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("e"))).thenReturn(-10.887174);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("e1"))).thenReturn(-10.889909);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("e2"))).thenReturn(-10.884445);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("eb1"))).thenReturn(-8.117126);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("eb2"))).thenReturn(-7.226952);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("eb3"))).thenReturn(-6.680537);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("o"))).thenThrow(new IllegalArgumentException("log2"));
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("o1"))).thenReturn(-0.000001);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("o2"))).thenReturn(0.000001);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("oc1"))).thenReturn(4.339208);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("oc2"))).thenReturn(5.303122);
        Mockito.when(log2Module.log2(MapValues.rightPoints.get("oc3"))).thenReturn(5.875853);
